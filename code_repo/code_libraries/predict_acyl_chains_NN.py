...
class clf_lo_ld:
    ...
    main_dir = "/Users/nasirsiddiqui_2/Desktop/ML_research_final/"
    ...
    processed_dopc_phos = 0
    processed_dopc_nitro = 0
    ...
    def __init__(self, sys_name, sys_type, red_type, model_type ,n_point, start_frame_real, stop_frame_real):
        ...
        if self.red_type != "raw":
            ...
            self.scaler_name = str(self.model_type)+"_"+str(self.n_point)+"pt_scaler_"+str(self.red_type)+".sav"
    ...
    def process_all_input(self):
        ...
        if self.red_type == "ft_last":
            ...
            dopc_lower_sn1_df = convolve_features_valid(dopc_lower_sn1_df , self.n_red , self.stop_frame_real , label_type="pure")
            dopc_upper_sn1_df = convolve_features_valid(dopc_upper_sn1_df , self.n_red , self.stop_frame_real , label_type="pure")
            ...
            dopc_lower_sn1_df = sav_gol_features(dopc_lower_sn1_df , self.n_point , self.sav_gol_poly_order , self.stop_frame_real , label_type="pure")
            dopc_upper_sn1_df = sav_gol_features(dopc_upper_sn1_df , self.n_point , self.sav_gol_poly_order , self.stop_frame_real , label_type="pure")
