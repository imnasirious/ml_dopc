#!/usr/bin/env python3
"""
Fast XGB post-classification summary of acyl-chain height and xy radius.

This script uses already saved XGB classification labels only.
It uses ft_last convolution with window size 9 and saves only the compact
printed-summary table. Each cell is mean ± std.
"""
...
data_array_dir = project_root / "heavy_data_NO_GIT/data_arrays_by_chain_xgb"
output_dir = project_root / "heavy_data_NO_GIT/results_by_chain_new"
summary_csv = output_dir / "classified_XGB_height_rad_fast_printed_summary.csv"
...
print("\nXGB height/xy_rad printed summary table:")
